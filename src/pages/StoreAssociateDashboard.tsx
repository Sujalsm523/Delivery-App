...
const StoreAssociateDashboard: React.FC = () => {
  ...
  const vehicles = useVehicleProgress();
  ...
  const renderActiveTab = () => {
    switch (activeTab) {
      ...
      case "routing":
        return <RoutingTab routeTableData={routeTableData} />;
      case "inventory":
        return <InventoryTab forecastData={forecastData} stores={stores} />;
      case "tracking":
        return (
          <TrackingTab
            vehicles={vehicles}
  ...
  return (
    <div className="min-h-screen bg-stone-100">
      ...
      <main className="max-w-7xl mx-auto p-6">{renderActiveTab()}</main>
    </div>
  );
};
